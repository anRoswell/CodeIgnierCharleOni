...
<html lang="en">
  ...
  <header>
    ...
    <!-- <script type="text/javascript" src="<?php echo base_url(); ?>bootstrap/js/grafica.js"></script> -->
    <script type="text/javascript" src="<?php echo base_url(); ?>bootstrap/js/funciones.js"></script>
