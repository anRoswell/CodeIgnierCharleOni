                    ...
                    <div class="panel-body">
                        ...
                        <?php echo form_open('user_authentication/new_user_registration',array('role'=>'form')); ?>
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="E-mail" name="email_value" type="email" autofocus>
                                </div>
                        ...
                        <?php echo form_close(); ?>
                        <a href="<?php echo base_url() ?> " class="btn btn-sm btn-info btn-block">For Login Click Here</a>
                    </div>
                </div>
            </div>
        </div>
