...
<body>
    <div id="wrapper">
        <input type="hidden" id="ventasZonas" name="ventasZonas" value="<?php echo htmlspecialchars(json_encode($VentasZonas), ENT_QUOTES, 'UTF-8');  ?>">
        <!-- Navigation -->
        ...
        <div id="page-wrapper">
            ...
            <?php echo form_open('informesZonasController',array('role'=>'form')); ?>
                <div class="row">                    
                    <div class="col-sm-12 col-lg-3 col-md-6">
                        <input type="submit" value="Ventas Zonas" class="form-control" min="0">
                    </div>
                </div>
            <?php echo form_close(); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> CLC - Participación por Zona
                        </div>
                        <div class="panel-body">
    ...
    <?php echo form_open('user_authentication/logout',array('role'=>'form')); ?>
